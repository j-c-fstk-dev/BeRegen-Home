...
import { ArrowRight, Mail, Pilcrow, Settings, Twitter, Handshake, Code } from "lucide-react";
                ...
                <section className="py-24 sm:py-32">
                    <div className="container">
                        <div className="grid md:grid-cols-2 gap-16">
                            <div>
                                <h2 className="font-headline text-3xl font-bold tracking-tight mb-8">Contact Information</h2>
                                ...
                                <h2 className="font-headline text-3xl font-bold tracking-tight mt-16 mb-8">How We Can Collaborate</h2>
                            ...
                            <div>
                                <h2 className="font-headline text-3xl font-bold tracking-tight mb-8">Send Us a Message</h2>
                                <Card>
            ...
            <FadeIn>
                <section className="py-24 sm:py-32 bg-primary/10">
                    <div className="container text-center max-w-3xl mx-auto">
                        <h2 className="font-headline text-3xl font-bold tracking-tight">Let’s Regenerate the Future Together</h2>
                        <div className="mt-8 flex justify-center gap-4">
                            <Button size="lg" asChild><Link href="/hub">Start a Pilot</Link></Button>
                            <Button size="lg" variant="outline" asChild><Link href="/team">Talk to the Team</Link></Button>
                            <Button size="lg" variant="outline" asChild><Link href="/ecosystem">Explore RegenHub</Link></Button>
                        </div>
                    </div>
                </section>
            </FadeIn>
