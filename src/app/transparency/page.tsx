    ...
    <>
      ...
      <FadeIn>
        <section className="py-24 sm:py-32">
          <div className="container">
            <h2 className="font-headline text-3xl font-medium text-center">On-chain Metrics</h2>
            <p className="mt-4 text-neutral-600 text-center max-w-2xl mx-auto">Live data from our smart contracts, visualized via Dune and TheGraph.</p>
      ...
      <FadeIn>
         <section className="py-24 sm:py-32 bg-card border-y">
          <div className="container">
            <h2 className="font-headline text-3xl font-medium text-center">Financial Reports</h2>
            <p className="mt-4 text-neutral-600 text-center max-w-2xl mx-auto">Download our periodic financial reports for a detailed breakdown of our treasury and expenditures.</p>
       ...
       <FadeIn>
        <section className="py-24 sm:py-32">
          <div className="container">
            <h2 className="font-headline text-3xl font-medium text-center">Audits & Methodology</h2>
            <p className="mt-4 text-neutral-600 text-center max-w-2xl mx-auto">Our smart contracts are professionally audited for security, and our methodologies are publicly documented.</p>
            <div className="mt-12 grid md:grid-cols-2 gap-8">
                ...
                <Card>
                    ...
                    <CardContent>
                        <p className="text-sm text-neutral-600">Our methodology for calculating off-chain metrics like 'Verified Actions' is documented in our <Button variant="link" className="p-0 h-auto">Transparency Handbook</Button>.</p>
                    </CardContent>
                </Card>
            </div>
          </div>
