    ...
    <>
      ...
      <FadeIn>
        <section className="py-24 sm:py-32">
            <div className="container text-center">
                ...
                <p className="mt-4 text-muted-foreground max-w-2xl mx-auto">A simple yet powerful flow to integrate regenerative habits into your daily routine.</p>
      ...
      <FadeIn>
        <section className="py-24 sm:py-32 bg-card border-y">
            <div className="container grid md:grid-cols-2 gap-16 items-center">
                <div>
                    <h2 className="font-headline text-3xl font-bold tracking-tight">Key Features</h2>
                    <p className="mt-4 text-muted-foreground">Tools designed to make regeneration a natural part of your life.</p>
                ...
                <div className="grid grid-cols-2 gap-4">
                    {screens.slice(0,2).map(s => (
                        <Image key={s.id} src={s.imageUrl} alt={s.description} width={600} height={400} className="rounded-lg object-cover" data-ai-hint={s.imageHint} />
                    ))}
                </div>
            </div>
        </section>
      ...
      <FadeIn>
        <section className="py-24 sm:py-32 bg-primary/10">
          <div className="container text-center">
             <h2 className="font-headline text-3xl font-bold tracking-tight">Start Your Regenerative Journey</h2>
             <p className="mt-4 text-muted-foreground max-w-2xl mx-auto">Access the platform or download the app to begin.</p>
             <div className="mt-8 flex justify-center gap-4">
                <Button size="lg" asChild><Link href="#">Access Platform <ArrowRight className="ml-2 h-4 w-4"/></Link></Button>
