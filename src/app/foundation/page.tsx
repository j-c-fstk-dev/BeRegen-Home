  ...
  return (
    <>
      ...
      <FadeIn>
        <section className="py-24 sm:py-32 bg-card border-y">
            <div className="container text-center">
                <h2 className="font-headline text-3xl font-medium">Principles & Ethics</h2>
                <p className="mt-4 text-neutral-600 max-w-2xl mx-auto">Our work is guided by a strong ethical compass, ensuring our actions align with our regenerative mission.</p>
                <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-8">
                    {principles.map(p => (
                        <div key={p.title} className="flex flex-col items-center text-center">
                            <div className="bg-primary/10 p-4 rounded-full mb-4 text-primary">{p.icon}</div>
                            <h3 className="font-headline text-xl font-medium">{p.title}</h3>
      ...
      <FadeIn>
        <section className="py-24 sm:py-32">
            <div className="container text-center">
                 <h2 className="font-headline text-3xl font-medium">Team & Advisors</h2>
                <p className="mt-4 text-neutral-600 max-w-2xl mx-auto">The dedicated individuals bringing the BeRegen vision to life.</p>
                        ...
                        return (
                            <div key={t.name} className="flex flex-col items-center">
                                <Avatar className="w-24 h-24 mb-4">
                                    {image && <AvatarImage src={image.imageUrl} alt={t.name} data-ai-hint={image.imageHint}/>}
      ...
      <FadeIn>
        <section className="py-24 sm:py-32 bg-primary/10">
          <div className="container text-center">
             <h2 className="font-headline text-3xl font-medium">Ready to Dive Deeper?</h2>
             <p className="mt-4 text-neutral-600 max-w-2xl mx-auto">Explore our technical documentation or join our community to get involved.</p>
             <div className="mt-8 flex justify-center gap-4">
                <Button size="lg" asChild><Link href="/docs">Read the Docs</Link></Button>
